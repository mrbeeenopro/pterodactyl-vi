        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Chi tiết Mount</h3>
                </div>
                ...
                <form action="{{ route('admin.mounts.view', $mount->id) }}" method="POST">
                    ...
                    <div class="box-footer">
                        ...
                        <button name="action" value="edit" class="btn btn-sm btn-primary pull-right">Lưu</button>
        ...
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addEggsModal">Thêm Eggs</button>
                    </div>
                </div>
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addNodesModal">Thêm Nodes</button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.eggs', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Thêm Eggs</h4>
                    </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.nodes', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Thêm Nodes</h4>
                    </div>
...
@section('footer-scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#pEggs').select2({
                placeholder: 'Chọn eggs..',
            });

            $('#pNodes').select2({
                placeholder: 'Chọn nodes..',
            });
            ...
            $('button[data-action="detach-egg"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    swal({ type: 'success', title: 'Đã gỡ egg.' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'Whoops!',
            ...
            $('button[data-action="detach-node"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    element.parent().parent().addClass('warning').delay(100).fadeOut();
                    swal({ type: 'success', title: 'Đã gỡ node.' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'Whoops!',
