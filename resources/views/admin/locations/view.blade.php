...
@section('title')
    Địa điểm &rarr; Xem &rarr; {{ $location->short }}
@endsection
...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.locations') }}">Địa điểm</a></li>
