                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Đây phải là một tên danh mục mô tả bao gồm tất cả các tùy chọn trong dịch vụ.</small></p>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">Một ID duy nhất được sử dụng để xác định nest này trong nội bộ và thông qua API.</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">Tác giả của tùy chọn dịch vụ này. Vui lòng gửi câu hỏi và vấn đề cho họ trừ khi đây là một tùy chọn chính thức được ủy quyền bởi <code>support@pterodactyl.io</code>.</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">Một UUID mà tất cả các máy chủ sử dụng tùy chọn này được gán cho mục đích nhận dạng.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-footer">
                <a href="{{ route('admin.nests.egg.new') }}"><button class="btn btn-success btn-sm pull-right">Egg mới</button></a>
            </div>
        </div>
    </div>
</div>
