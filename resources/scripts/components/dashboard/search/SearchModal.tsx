...
export default ({ ...props }: Props) => {
    ...
    const search = debounce(({ term }: Values, { setSubmitting }: FormikHelpers<Values>) => {
        ...
        // nếu ref.current tồn tại, đặt focus vào đó
    ...
    // Formik không hỗ trợ innerRef trên các component tùy chỉnh.
    ...
    return (
        <Formik
            ...
            validationSchema={object().shape({
                term: string().min(3, 'Vui lòng nhập ít nhất ba ký tự để bắt đầu tìm kiếm.'),
            })}
                ...
                <Modal {...props}>
                    <Form>
                        <FormikFieldWrapper
                            ...
                            description={'Nhập tên máy chủ, uuid, hoặc allocation để bắt đầu tìm kiếm.'}
                        >
                            <SearchWatcher />
