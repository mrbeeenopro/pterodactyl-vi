        ...
        <form id={'enable-totp-form'} onSubmit={submit}>
            ...
            <CopyOnClick text={token?.secret}>
                <p className={'font-mono text-sm text-gray-100 text-center mt-2'}>
                    {token?.secret.match(/.{1,4}/g)!.join(' ') || 'Đang tải...'}
                </p>
            </CopyOnClick>
            <p id={'totp-code-description'} className={'mt-6'}>
                Quét mã QR ở trên bằng ứng dụng xác thực hai bước mà bạn chọn. Sau đó, nhập mã 6 chữ số được tạo vào trường bên dưới.
            </p>
            <Input.Text
            ...
            <Dialog.Footer>
                ...
                <Tooltip
                    ...
                    content={
                        !token
                            ? 'Đang chờ mã QR tải...'
                            : 'Bạn phải nhập mã 6 chữ số và mật khẩu để tiếp tục.'
                    }
                    delay={100}
                >
                    <Button
...
export default asDialog({
    title: 'Kích hoạt Xác minh Hai bước',
    description:
        'Giúp bảo vệ tài khoản của bạn khỏi truy cập trái phép. Bạn sẽ được yêu cầu nhập mã xác minh mỗi khi đăng nhập.',
