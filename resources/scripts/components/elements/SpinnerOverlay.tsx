...
interface Props {
    ...
    isBlue?: boolean; // Added to support the new Spinner prop
}

const SpinnerOverlay: React.FC<Props> = ({ size, fixed, visible, backgroundOpacity, isBlue = false, children }) => (
    <Fade timeout={150} in={visible} unmountOnExit>
        ...
        >
            <Spinner size={size} centered isBlue={isBlue} />
