...
const schema = object().shape({
    directoryName: string().required('Tên thư mục hợp lệ là bắt buộc.'),
});
        ...
        <Formik onSubmit={submit} validationSchema={schema} initialValues={{ directoryName: '' }}>
            {({ submitForm, values }) => (
                <>
                    ...
                    <Form css={tw`m-0`}>
                        <Field autoFocus id={'directoryName'} name={'directoryName'} label={'Tên'} />
                        <p css={tw`mt-2 text-sm md:text-base break-all`}>
                            <span css={tw`text-neutral-200`}>Thư mục này sẽ được tạo tại&nbsp;</span>
                            <Code>
                                /home/container/
