    ...
    return (
        <div className={'space-y-2 mt-6'}>
            ...
            <Dialog.Footer>
                ...
                <Button.Text onClick={close}>Đóng</Button.Text>
            </Dialog.Footer>
        </div>
    );
};
...
const FileUploadListDialog = asDialog({
    title: 'Tải lên tệp',
    description: 'Các tệp sau đang được tải lên máy chủ của bạn.',
})(FileUploadList);
...
export default () => {
    ...
    return (
        <>
            {count > 0 && (
                <Tooltip content={`${count} tệp đang được tải lên, nhấn để xem`}>
                    <button
